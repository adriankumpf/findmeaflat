const { filterNonNullables, shorten, random } = require('lib/utils')
  ...
  async run() {
    ...
    for (const listing of newListings) {
      ...
      const msg =
        ...
        filterNonNullables([listing.address, listing.price, listing.size, listing.property_size, listing.rooms]).join(' | ') + 
        '\n' +
        `[LINK](${listing.link})`
